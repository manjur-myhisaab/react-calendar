...
export default function Tile(props) {
  ...
  return _jsx('button', {
    ...
    disabled:
      ...
      (tileDisabled === null || tileDisabled === void 0
        ? void 0
        : tileDisabled({ activeStartDate: activeStartDate, date: date, view: view })),
    onClick: onClick
      ? function (event) {
    ...
    children: _jsxs('div', {
      children: [
        formatAbbr
          ? _jsx('abbr', { 'aria-label': formatAbbr(locale, date), children: children })
          : children,
        tileContent,
      ],
    }),
