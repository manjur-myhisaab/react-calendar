...
var Calendar = forwardRef(function Calendar(props, ref) {
  ...
  var getProcessedValue = useCallback(
    function (value) {
  ...
  var setActiveStartDate = useCallback(
    ...
    switch (view) {
      case 'century': {
        return _jsx(
          CenturyView,
          __assign(
            { formatYear: formatYear, showNeighboringCentury: showNeighboringCentury },
            commonProps,
          ),
        );
      }
      case 'decade': {
        return _jsx(
          DecadeView,
          __assign(
            { formatYear: formatYear, showNeighboringDecade: showNeighboringDecade },
            commonProps,
          ),
        );
      }
      case 'year': {
        return _jsx(
          YearView,
          __assign({ formatMonth: formatMonth, formatMonthYear: formatMonthYear }, commonProps),
        );
      }
      case 'month': {
        return _jsx(
  ...
  return _jsxs('div', {
    className: clsx(
      baseClassName,
      selectRange && valueArray.length === 1 && ''.concat(baseClassName, '--selectRange'),
      showDoubleView && ''.concat(baseClassName, '--doubleView'),
      className,
    ),
    ref: inputRef,
    children: [
